<template>
  <div class="login-container" @mousemove="handleMouseMove">
    ...
    <div class="login-card">
      ...
      <p class="login-subtitle">理财服务平台</p>
...
async function handleLogin() {
  ...
  try {
    ...
    const adminUrl = isDev ? `http://localhost:3000/admin/${tokenParam}` : '/admin/#/'
    const userUrl = isDev ? `http://localhost:3001/user/${tokenParam}` : '/user/#/'
