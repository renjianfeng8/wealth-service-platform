...
class FinTradeOrderServiceImplTest {

    @Mock
    private FinTradeOrderMapper tradeOrderMapper;
    ...
    private FinTradeOrderServiceImpl tradeOrderService;
    ...
    void createOrder_Success() {
        FinTradeOrderDTO dto = new FinTradeOrderDTO();
        dto.setUserId(100L);
        ...
        when(messageFeignClient.createMessage(any(MessageFeignDTO.class))).thenReturn(null);
        ...
        // 验证 Feign 消息推送
        verify(messageFeignClient).createMessage(argThat(msg ->
                100L == msg.getUserId() &&
                2 == msg.getMsgType() &&
    ...
    void createOrder_SaveFailed() {
        ...
        verify(messageFeignClient, never()).createMessage(any());
    }
    ...
    void getOrderById_Found() {
        ...
        FinTradeOrderVO result = tradeOrderService.getOrderById(1L);
    ...
    void getOrderById_NotFound() {
        ...
        FinTradeOrderVO result = tradeOrderService.getOrderById(99L);
