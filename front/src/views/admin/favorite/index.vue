<template>
  <div class="page">
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit?'编辑自选':'新增自选'" width="400px" :before-close="handleDialogClose">
...
function handleReset() { query.userId = undefined as any; query.productCode = ''; handleSearch() }
function handleSizeChange() { query.pageNum = 1; fetchData() }
function handleAdd() { isEdit.value = false; Object.assign(form, { id: undefined, userId: undefined, productCode: '' }); reset(); dialogVisible.value = true }
