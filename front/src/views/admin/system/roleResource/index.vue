...
const tableData = ref<RoleResourceRelation[]>([])
const total = ref(0)
...
async function handleDelete(id?: number) {
  if (!id) return
  try {
    await deleteRoleResourceRelation(id)
...
function formatDateColumn(_row: RoleResourceRelation, _column: unknown, value: string) {
