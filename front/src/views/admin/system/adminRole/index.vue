  ...
  <div class="page">
    ...
    <el-card shadow="never" class="search-card">
      <el-form :model="query" inline>
        <el-form-item label="管理员"><el-select v-model="query.adminId" clearable filterable style="width:200px" placeholder="选择管理员"><el-option v-for="a in adminList" :key="a.id" :label="a.nickName || a.username" :value="a.id" /></el-select></el-form-item>
...
const adminList = ref<any[]>([]); const roleList = ref<any[]>([])
const dialogVisible = ref(false)
const formRef = ref<FormInstance>()
const query = reactive({ pageNum: 1, pageSize: 10, adminId: '' })
...
function getAdminName(id: number) { return adminMap.get(id) || `ID:${id}` }
...
function handleReset() { query.adminId = ''; handleSearch() }
