...
const quickActions = [
  ...
  { label: '我的自选', path: '/user/favorite', icon: Star, bg: 'linear-gradient(135deg, #ff9500, #e68a00)' },
  { label: '交易委托', path: '/user/trade', icon: Money, bg: 'linear-gradient(135deg, #ff3b30, #d63031)' },
  { label: '财经资讯', path: '/news', icon: Notebook, bg: 'linear-gradient(135deg, #8e44ad, #6c3483)' },
  { label: '消息中心', path: '/user/message', icon: Message, bg: 'linear-gradient(135deg, #00b894, #00a381)' },
]
