...
public class ProductSyncServiceImpl implements ProductSyncService {
    ...
    public ProductSyncServiceImpl(SearchService searchService, FinProductMapper productMapper) {
    ...
    public void syncSingleToES(WeaProduct product) {
        try {
            searchService.saveProduct(toSyncDTO(product));
