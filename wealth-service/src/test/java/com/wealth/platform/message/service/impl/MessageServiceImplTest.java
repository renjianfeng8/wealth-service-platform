...
class MessageServiceImplTest {
    ...
    void getMessageById_Found() {
        ...
        MessageVO result = messageService.getMessageById(1L);
    ...
    void pageMessages_WithUserId() {
        ...
        IPage<MessageVO> result = messageService.pageMessages(page, 100L, null, null, null);
    ...
    void pageMessages_WithoutUserId() {
        ...
        IPage<MessageVO> result = messageService.pageMessages(page, null, null, null, null);
    ...
    void updateMessage_NotFound() {
        ...
        assertThrows(ServiceException.class, () ->
                messageService.updateMessage(99L, new MessageDTO()));
